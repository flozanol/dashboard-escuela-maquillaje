<td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">
        ...
        {/* Top Escuelas por Cobranza y Top Conceptos de Ingresos (ACTUALIZADO) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Top Conceptos de Ingresos (NUEVO) */}
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center gap-2 mb-4">
              <BarChart3 className="w-5 h-5 text-indigo-500" />
              <h3 className="text-lg font-semibold">Top Conceptos de Ingresos</h3>
            </div>
            <div className="space-y-4">
              {ingresosData
                ...
                .map((item, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-sm">${item.monto.toLocaleString()}</p>
        ...
        {/* Resumen Comparativo Cobranza vs Ingresos (NUEVO) */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-lg font-semibold mb-4">📊 Resumen Comparativo: Cobranza vs Tabla de Ingresos</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <p className="text-blue-800 font-semibold text-lg">Total Cobranza</p>
              <p className="text-3xl font-bold text-blue-900">
                ${Object.values(totalesPorMes).reduce((sum, val) => sum + val, 0).toLocaleString()}
              </p>
              <p className="text-blue-600 text-sm">Cobranza por escuelas</p>
            </div>
            
            <div className="text-center p-4 bg-indigo-50 rounded-lg">
              <p className="text-indigo-800 font-semibold text-lg">Total Ingresos</p>
              <p className="text-3xl font-bold text-indigo-900">
                ${totalIngresos.toLocaleString()}
              </p>
              <p className="text-indigo-600 text-sm">Tabla de ingresos</p>
            </div>
            
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <p className="text-green-800 font-semibold text-lg">Diferencia</p>
              <p className="text-3xl font-bold text-green-900">
                ${(Object.values(totalesPorMes).reduce((sum, val) => sum + val, 0) - totalIngresos).toLocaleString()}
              </p>
              <p className="text-green-600 text-sm">
                {Object.values(totalesPorMes).reduce((sum, val) => sum + val, 0) > totalIngresos ? 'Cobranza mayor' : 'Ingresos mayor'}
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• La cobranza total es de ${Object.values(totalesPorMes).reduce((sum, val) => sum + val, 0).toLocaleString()}</li>
              <li>• Los ingresos registrados suman ${totalIngresos.toLocaleString()}</li>
              <li>• Se tienen {escuelas.length} escuelas activas en cobranza</li>
              <li>• Se registran {ingresosData.length} conceptos diferentes de ingresos</li>
              <li>• El concepto de mayor ingreso es: {ingresosData.sort((a, b) => b.monto - a.monto)[0]?.concepto}</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Vistas de tablas */}
        {(viewType === "escuela" || viewType === "area" || viewType === "instructor" || viewType === "curso") && !isLoading && viewType !== "contacto" && (
          <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
...
export default Dashboard;          {connectionStatus === 'connected' && (
  ...
  // Dashboard de Cobranza mejorado con Tabla de Ingresos (NUEVO)
  const CobranzaDashboard = () => {
    ...
    // Calcular totales de ingresos (NUEVO)
    ...
    return (
      <div className="space-y-6">
        {/* Resumen de Cobranza e Ingresos (ACTUALIZADO) */}
        ...
        {/* Nueva sección: Tabla de Ingresos y Gráfico (NUEVO) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Tabla de Ingresos */}
          <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          {/* Gráfico de Pastel de Ingresos (NUEVO) */}
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h3 className="text-lg font-semibold mb-4">Distribución de Ingresos por Concepto</h3>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                  ...
                  <tr key={escuela} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">
                      <div className="flex items-center gap-2">
                        <Building className="w-4 h-4 text-gray-500" />
                        {escuela}
                      </div  // Función para obtener totales por medio de contacto
  ...
  // Componente para el dashboard de medios de contacto
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          {connectionStatus === 'connected' && (
            <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-sm text-green-800">
                <strong>✅ Conectaimport React, { useState, useMemo, useEffect } from 'react';
...
// Datos de fallback para ingresos (NUEVO)
...
const Dashboard = () => {
  ...
  // Función para ordenar meses cronológicamente (simplificada para deploy)
  ...
  // Función para transformar datos de medios de contacto
  ...
  // Computed para medios de contacto
  ...
  // Función para obtener totales por medio de contacto
  const getContactTotals = (month) =>
