      ...
      <div className="bg-white rounded-xl shadow-lg p-5 border-t-4" style={{ borderColor: color }}>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="w-full h-2.5 rounded-full overflow-hidden" style={{ backgroundColor: IDIP_LIGHT_GRAY }}>
              <div className="h-full transition-all duration-700" style={{ 
                width: `${Math.min(avanceV, 100)}%`,
                backgroundColor: getProgressColor(avanceV) 
              }}></div>
            </div>
          </div>
          <div>
            ...
            <div className="w-full h-2.5 rounded-full overflow-hidden" style={{ backgroundColor: IDIP_LIGHT_GRAY }}>
              <div className="h-full transition-all duration-700" style={{ 
                width: `${Math.min(avanceC, 100)}%`,
                backgroundColor: getProgressColor(avanceC) 
              }}></div>
            </div>
          </div>
